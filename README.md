...
Project page for *Keep It Cool: Optimal Control of Robotic Systems Under Temperature Constraints*, IEEE Transactions on Control Systems Technology, 2026.

**Live site:** https://ddebenedittis.github.io/keep_it_cool_website/

- Paper: https://doi.org/10.1109/TCST.2026.3721130
- Code: https://github.com/ddebenedittis/optimal_control_temperature_constraints
...
To reproduce the production build, including the `/keep_it_cool_website/` base path that GitHub Pages serves under:

```bash
docker run --rm -u "$(id -u):$(id -g)" -e HOME=/tmp -v "$PWD":/app -w /app node:lts \
  npx astro build --site "https://ddebenedittis.github.io" --base "/keep_it_cool_website/"
```
